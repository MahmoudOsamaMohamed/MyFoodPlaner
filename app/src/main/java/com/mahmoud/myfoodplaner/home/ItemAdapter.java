...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ItemViewHolder> {
    ...
    private List<ShortMeal> list = new ArrayList<>();
    NestedAdapter adapter;
    MealClickListener mealClickListener;

    public void setList(List<ShortMeal> list) {
        this.list = list;
    }

    public ItemAdapter(List<DataModel> mList, MealClickListener mealClickListener) {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        holder.mTextView.setText(model.getCategortyName());
        ...
        adapter = new NestedAdapter(list, mealClickListener);
